...
The --use-conda is necessary to indicate that conda will be used to manage the software dependencies of the pipeline, while the --cores parameter is used to tell Snakemake how many cpus can be used to assemble the samples (the more cpus you can use, the faster the assemblies will be completed).
